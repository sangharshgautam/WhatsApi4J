...
public class TokenMap {
	...
	private static final String[] secondaryStrings = {
	     "mpeg4",
	      "wmv",
	      "audio/3gpp",
	      "audio/aac",
    ...
    {
    	Token t = null;
        int token = array_search(string, primaryStrings);
        if (token > -1) {
        	t = new Token(token,string,false);
        } else {
        	token = array_search(string, secondaryStrings);
        	if (token > -1) {
        		t = new Token(token,string,true);
        	}
        }
//        if(t != null) { 
...
//        }
    ...
    private static int array_search(String name, String[] array) {
    	if(name == null)
    		return 0;
	...
	public static Token getToken(int token, boolean subdict) throws InvalidTokenException
    {
        ...
        String name = tokenMap[token];
        if ( name == null) {
            throw new InvalidTokenException("Invalid token/length in GetToken");
        }
		Token t = new Token(token, name, subdict);
//        if(t != null) { 
//        	log.debug("Found token "+t);
//        }
		return t;
